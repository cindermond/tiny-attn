from transformers.models.albert.modeling_albert import AlbertPreTrainedModel, AlbertEmbeddings, AlbertAttention
...
class AlbertModelBL(AlbertPreTrainedModel):
